...
The shared template pattern is the real architectural takeaway. Rendering strategies are about _when and where_ you call your render function, not about writing different versions of it.
