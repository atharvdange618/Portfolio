      ...
      <div className="flex items-center gap-1 border-b border-border pb-4">
        {filters.map(({ label, value }) => (
          <button
            ...
            className={cn(
              "px-3 py-2 text-sm active:scale-[0.98] transition-all duration-200",
              active === value
          ...
          {filtered.map((project) => (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                {project.featured && (
                  <span role="img" className="text-yellow text-sm" aria-label="Featured project">★</span>
                )}
              </div>
              ...
              <div className="flex items-center gap-4 mt-1 text-sm">
                <Link
                  href={`/projects/${project.slug}`}
                  className="text-fg hover:text-purple active:scale-[0.98] transition-all duration-200 flex items-center gap-1 py-2 group"
                >
                ...
                {project.github && (
                  <a
                    ...
                    className="text-comment hover:text-fg active:scale-[0.98] transition-all duration-200 flex items-center gap-1 py-2"
                  >
