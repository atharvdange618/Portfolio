...
const stackGroups = [
  {
    label: "Core",
    items: ["TypeScript", "Node.js", "React", "Next.js", "PostgreSQL"],
  },
  { label: "Mobile", items: ["React Native", "Expo"] },
  {
    label: "Tooling",
    items: ["TanStack Query", "Zustand", "Zod", "Prisma", "Axios"],
  },
  { label: "Infra", items: ["Vercel", "Git", "Bun"] },
      ...
      <div className="flex flex-col gap-3">
        {stackGroups.map(({ label, items }) => (
          <div key={label} className="flex flex-col sm:flex-row gap-2 sm:gap-6">
            <span className="text-comment text-base w-20 shrink-0">{label}</span>
